...
/*
  ...
  Ex. If Jake were passed in as the argument, the function would log 'Hello, '
...
let test = exclaimThree('Im so excited')
console.log(test)
...
let favMovie = bestMovie('Sharknado')
...
/*
 ...
 /CODE HERE
*/
function theEliminator(cont, losers) {
...
console.log(emailCheck('name@email.com'))
...
let totalFrogs2 = chocFrogs2(1000)
...
console.log(ascArray(sampleArray))
